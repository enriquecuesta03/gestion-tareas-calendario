...
function DashboardLayout({ token, nombreUsuario, onLogout, temaOscuro, setTemaOscuro }) {
  ...
  // ==========================================
  // ESTADOS DE LA INTERFAZ Y MODALES
  // ==========================================
  ...
  // ==========================================
  // 1. CONEXIÓN CON LOS DATOS (EL HOOK CRUD)
  // ==========================================
  const { 
  ...
  // ==========================================
  // 2. CONEXIÓN CON LA IA (HOOK KORA)
  // ==========================================
  ...
  // ==========================================
  // LÓGICA DE INTERFAZ Y MANEJADORES
  // ==========================================
  ...
  // ==========================================
  // FORMATEO DE DATOS PARA VISTAS (Kanban, Calendario)
  // ==========================================
